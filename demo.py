...
def main(mesh_path = os.path.join("face_scans", "Serag_Rest_clipped.stl"), reorient = False):
    '''
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mesh", help="specifies the path to the face mesh", default=os.path.join("face_scans", "Serag_Rest_clipped.stl"))
